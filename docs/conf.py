# -*- coding: utf-8 -*-
#
# cbcflow documentation build configuration file, created by
...
project = u'cbcflow'
copyright = u'2016, Øyvind Evju and Martin Sandve Alnæs'
...
#import cbcflow
release = "2016.1.0"  # cbcflow.__version__
...
latex_documents = [
  ('index', 'cbcflow.tex', u'cbcflow Documentation',
   u'Øyvind Evju and Martin Sandve Alnæs', 'manual'),
]
...
man_pages = [
    ('index', 'cbcflow', u'cbcflow Documentation',
     [u'Øyvind Evju and Martin Sandve Alnæs'], 1)
]
...
texinfo_documents = [
  ('index', 'cbcflow', u'cbcflow Documentation',
   u'Øyvind Evju and Martin Sandve Alnæs', 'cbcflow', 'Navier-Stokes solver.',
   'Miscellaneous'),
]
