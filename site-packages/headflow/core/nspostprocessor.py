...
class NSPostProcessor(Parameterized):
    ...
    def find_dependencies(self, field):
        ...
        # FIXME: This needs refactoring to avoid mixing the
        #        code inspection part with cache manipulation,
        #        too much to take in at once...
        #        Code like this should have some serious unit test as well...
        ...
        for dep in deps_raw:
            ...
            # TODO: If we do make fields for t, timestep, pressure, velocity, they can be treated as such in generic code?
    ...
    def add_field(self, field):
        ...
        if isinstance(field, str):
            if field in self._fields.keys():
                ...
                # FIXME: Need a proper factory solution for this, perhaps a collection of known fields
                def create_field_from_name(name):
                    return eval(d[0])(params=None) # FIXME: [martinal] Doesnt work for me, is something not checked in?
                field = create_field_from_name(field)
        ...
        # Expand cache # TODO: [martin] I don't (yet) understand what all the Nones do in the cache.
    ...
    def update_all(self, u, p, t, timestep, problem):
        ...
        self._cache[0]["Velocity"] = u # TODO: Convert to canonical representation as vector valued function!
