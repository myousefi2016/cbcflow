...
def update_check(ppfield, t, timestep):
    ...
    if (ppfield.params.timeparams.start_timestep > timestep
        or timestep > ppfield.params.timeparams.end_timestep):
        return False

    if (ppfield.params.timeparams.start_time > t
        or t > ppfield.params.timeparams.end_time):
        return False
