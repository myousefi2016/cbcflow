...
class AdaptiveTimestepping(Parameterized):
    def __init__(self, params=None):
        Parameterized.__init__(self, params)
        
        self.dt = self.params.dt
        self.t = self.params.T0 + self.dt
        
        self.T = self.params.T
        self.T0 = self.params.T0
        
        self.timestep = self.params.timestep0 + 1
    ...
    def adjusted_timestep(self, check_value):
        ...
        #    self.t += self.dt
        #print is_modified
        #print "hei", self.timestep, self.t
