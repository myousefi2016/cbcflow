...
class NSProblem2(Parameterized):
    ...
    def boundary_conditions(self, spaces, u0, p0, t, controls):
        """Return boundary conditions in raw format.

        TODO: Document expected boundary_conditions behaviour here.
        TODO: should u0, p0 be last timestep, trial functions, what?
        """
        raise NotImplementedError("boundary_conditions must be overridden in subclass")

    def body_force(self, spaces, t=0): # TODO: Supply time from schemes, to support e.g. time-varying gravity
        """"Return body force, defaults to 0.

        TODO: Document expected body_force behaviour here."""
        d = self.mesh.topology().dim()
        c0 = Constant(0.0)
        return [c0]*d # TODO: Use as_vector here instead of in schemes

    # TODO: Merge into one update?
    def update(self, spaces, timestep, t, u0, p0, observations, controls):
        pass
    def update_observations(self, spaces, t, observations):
        pass
    def update_controls(self, spaces, t, controls):
        pass
    def update_boundary_conditions(self, spaces, u0, p0, t, bcs):
        pass
