...
class NSScheme(Parameterized):
    ...
    - The class methods shortname() and description() return one-word and one-sentence scheme descriptions.

    - Implement default_user_params(cls) to add scheme-specific parameters.

    - The solve function executes the scheme with a given problem.

    FIXME: Move functions and members that are not scheme-related out of this class
    """
    ...
    def description(self):
        "Get a one-word description of the scheme. By default uses first line of class docstring."
        return cls.__doc__.split('\n')[0]

    def __str__(self):
        return self.shortname() # TODO: I think description is nicer, using shortname for temporary compatibility.
