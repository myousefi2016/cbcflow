...
class NSScheme:
    ...
    def default_scheme_params(cls):
        "Subclasses should implement this to define scheme specific parameters."
        return {}
    ...
    def default_params(cls):
        ...
        # Insert scheme specific parameters
	params.update_recursive(cls.default_scheme_params())
        return params
