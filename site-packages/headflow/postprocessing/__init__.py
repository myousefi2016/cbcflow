...
all_fields = [
    ...
    "TimeDerivative", "SecondTimeDerivative",
    "L2norm", "H1norm", "H1seminorm",
    "RunningAvg", "RunningMin", "RunningMax",
    "DomainAvg", "BoundaryAvg",
...
__all__ = ["PPField", "MetaPPField", "field_classes", "all_fields"] + all_fields
