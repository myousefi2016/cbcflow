...
class WSS(PPFieldBase):
    ...
    def before_first_update(self, u, p, t, timestep, problem):
        ...
        try:
            ...
            if MPI.num_processes == 1:
                ...
                headflow_warning("Unable to load boundary mesh (parameter: problem.params['boundary_mesh_file']) or mapping (parameter: problem.params['boundary_entity_map_file']).\
    ...
    def update(self, u, p, t, timestep, problem):
        ...
        # Logic goes here
        assemble2(self.stress, tensor=self.tau.vector())
