    ...
    def solve(self, problem, restart=None):
        ...
        for t in t_range:
            ...
            for d in dims:
                ...
                self.timer("u0 solve (%s, %d dofs, %d iter)"%(', '.join(self.params.solver_u_tent), b.size(), iter))
            ...
            for d in dims:
                ...
                self.timer("u1 solve (%s, %d dofs, %d iter)"%(', '.join(self.params.solver_u_corr), b.size(), iter))
