...
class IPCS(NSScheme):
    ...
    def solve(self, problem, update):
        ...
        for timestep in xrange(1,len(timesteps)):
            ...
            timer.completed("u1 solve (%s, %d, %d)"%(', '.join(solver), b.size(), iter))
            ...
            timer.completed("p solve (%s, %d, %d)"%(', '.join(solver), b.size(), iter))
            ...
            timer.completed("u2 solve (%s, %d, %d)"%(', '.join(solver), b.size(),iter))
