...
class IPCS_stable(NSScheme):
    ...
    def solve(self, problem, update, restart=None):
        ...
        if restart: # FIXME: broken
            ...
            u_prev = as_vector([project(_, V) for _ in u0])
            u_curr = as_vector([Function(_) for _ in u_prev])
        ...
        # Functions
        u_next = as_vector([Function(V) for d in dims]) # u^{n+1}
        ...
        for timestep in xrange(1,len(timesteps)):
            ...
            update(u_next, p_next, t, timestep)
