...
class PenaltyIPCS(NSScheme):
    ...
    def solve(self, problem, update):
        ...
        u0.assign(project(as_vector(uinit), V))
        ...
        # Let dolfin-adjoint know that we're starting the timeloop
        ...
        for timestep in xrange(1,len(timesteps)):
            ...
            # Let dolfin-adjoint know that we are advancing to the next timestep
